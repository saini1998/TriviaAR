//  QueOneViewController.swift


import UIKit

class QueOneViewController: UIViewController {
    ...
    @objc func updateView() {
        ...
        optionOneButton.setTitle("Cricket", for: .normal)
        optionTwoButton.setTitle("Football", for: .normal)
        optionThreeButton.setTitle("Volleyball", for: .normal)

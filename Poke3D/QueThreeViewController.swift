//  QueThreeViewController.swift


import UIKit

class QueThreeViewController: UIViewController {
    ...
    @objc func updateView() {
        ...
        optionOneButton.setTitle("Batman", for: .normal)
        optionTwoButton.setTitle("Superman", for: .normal)
        optionThreeButton.setTitle("Wonder Woman", for: .normal)
